...
class GolCompilerGUI:
    """
    Interface Gráfica para o Analisador Léxico Automático (PLY) Gol++
    Implementada em Tkinter
    """
    
    def __init__(self, root):
        self.root = root
        self.root.title("Gol++ Compiler - Analisador Léxico (Automático - PLY)")
    ...
    def montar_interface(self):
        ...
        # Título
        titulo = tk.Label(self.root, text="⚽ Gol++ Analisador Léxico (Automático - PLY)", font=("Segoe UI", 16, "bold"), bg="#1E1E1E", fg="#4CAF50")
        titulo.pack(pady=10)
    ...
    def analisar_codigo(self):
        ...
        if erros:
            ...
            self.text_erros.config(fg="#4CAF50")
